...
function ProtectingYourSafety() {
  return (
    ...
    <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      ...
      >
        <Image loading='lazy' src={blinds} alt="Blinds" width={600} height={400} className="w-full h-48 object-cover" priority  />
        <div className="p-4">
      ...
      <motion.div
        ...
        className="bg-white rounded-lg shadow-md overflow-hidden"
      >
        <Image loading='lazy' src={radio} alt="Radio" width={600} height={400} className="w-full h-48 object-cover" priority  />
        <div className="p-4">
      ...
      <motion.div
        ...
        className="bg-white rounded-lg shadow-md overflow-hidden"
      >
        <Image loading='lazy' src={house} alt="House" width={600} height={400} className="w-full h-48 object-cover" priority  />
        <div className="p-4">
      ...
      <motion.div
        ...
        className="bg-white rounded-lg shadow-md overflow-hidden"
      >
        <Image loading='lazy' src={gate} alt="Gate" width={600} height={400} className="w-full h-48 object-cover" priority />
        <div className="p-4">
      ...
      <motion.div
        ...
        className="bg-white rounded-lg shadow-md overflow-hidden"
      >
        <Image loading='lazy' src={gate1} alt="Gate 1" width={600} height={400} className="w-full h-48 object-cover" priority />
        <div className="p-4">
