...
const ArticlesPage: React.FC = () => {
   ...
   const menuItemsWindowHeader: MenuItem[] = [
      ...
      {
         label: t('homeAutomation'),
         link: '/articles/homeAutomation',
      },
      {
         label: t('climateControl'),
         link: '/articles/climateControl',
      },
      { label: t('smartLighting'), link: '/articles/smartLighting' },
      {
         label: t('smartHomeProject'),
         link: '/articles/smartHomeProject',
      },
      {
         label: t('SmartHomeOverview'),
         link: '/articles/SmartHomeOverview',
      },
   ];

   return (
      <>
         <nav className="pt-20 flex mb-5 flex-col gap-5 items-center">
